...
def generate_launch_description():
    ...
    for i in range(NUMBER_OF_BALLOONS):
        targets_to_spawn.append(spawn_sdf("resources/balloon/balloon.sdf", id = i, pos = (0, -i*7, 0)))
    ...
    vulnerable_positions = [(-25, 30), (-35, 30)]
    
    for i in range(2):
        xx, yy = vulnerable_positions[i]
        targets_to_spawn.append(spawn_sdf("resources/sensor/sensor.sdf", id = i, pos = (xx, yy, 0)))
