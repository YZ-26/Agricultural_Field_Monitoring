...
class SensorController(Node):
    ...
    def simple_publish(self):
        ...
        msg = String()
        msg.data = f"Sensor_{id} data: {self.generate_data()} Celcius!"

        self.tx_topic.publish(msg) 


    def generate_data(self):
        self.generated_data = random.gauss(30.0, 2.0)  #Temperature range in Celsius
        return round(self.generated_data, 2)
